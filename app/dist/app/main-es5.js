(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailComponent = /** @class */ (function () {
                function DetailComponent(route, userService, repositoryService) {
                    var _this = this;
                    this.route = route;
                    this.userService = userService;
                    this.repositoryService = repositoryService;
                    this.displayedColumns = ['id', 'name', 'url'];
                    this.route.params.subscribe(function (res) { return _this.login = res.login; });
                ...
                DetailComponent.prototype.GetUser = function (login) {
                    var _this = this;
                    this.userService.GetDetail(login).subscribe(function (data) {
                        _this.user = data;
                    });
                };
                DetailComponent.prototype.GetRepositories = function (login) {
                    var _this = this;
                    this.repositoryService.GetByLogin(login).subscribe(function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListComponent = /** @class */ (function () {
                ...
                ListComponent.prototype.GetUsers = function () {
                    var _this = this;
                    this.userService.GetUsersPagination(1).subscribe(function (data) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RepositoryService = /** @class */ (function () {
                function RepositoryService(httpclient) {
                    this.httpclient = httpclient;
                    this.ApiUrl = 'http://localhost:5000/api/users';
                }
                RepositoryService.prototype.GetByLogin = function (login) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                ...
                UserService.prototype.GetUsersPagination = function (number) {
                    return this.httpclient.get(this.ApiUrl + '?since=' + number);
                };
                UserService.prototype.GetDetail = function (login) {
